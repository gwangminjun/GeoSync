...
class EndpointContractTest {
    ...
    private static final Class<?>[] CONTROLLERS = {
            geosync.monitoring.ApiTestController.class,
            geosync.gateway.ApiTestProxyController.class,
            geosync.gateway.ConnStatsController.class,
            geosync.monitoring.DashboardController.class,
            geosync.database.DbSetupController.class,
            geosync.kras.FileDownloadController.class,
            geosync.gateway.KrasConnController.class,
            geosync.gateway.KrasGmxController.class,
            geosync.monitoring.LogController.class,
            geosync.kras.MockGatewayController.class,
            geosync.ods.OdsController.class,
            geosync.synchronization.ScheduleController.class,
            geosync.settings.SettingsController.class,
            geosync.synchronization.SyncController.class
    };
