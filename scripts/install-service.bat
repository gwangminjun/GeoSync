...
"%SYNC_HOME%\bin\nssm.exe" set GeoSyncService AppParameters "-Djava.library.path=%SYNC_HOME%\lib -jar %SYNC_HOME%\lib\geomex-sync.jar --spring.config.location=file:%SYNC_HOME%\conf\application.yml"
